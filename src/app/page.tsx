    ...
    <div className="flex flex-col min-h-screen bg-background overflow-x-hidden">
      ...
      <section className="py-20 md:py-32 bg-gradient-to-br from-background via-primary/5 to-accent/5">
        <div className="container mx-auto px-4 text-center">
          ...
          <Button size="lg" asChild className="shadow-lg hover:scale-105 transition-transform animate-in fade-in zoom-in-95 duration-700 delay-400">
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <ul className="space-y-6">
              {[
                ...
                <li key={feature.text} className="flex items-start animate-in fade-in slide-in-from-left-12 duration-700" style={{ animationDelay: `${150 * (index + 1)}ms` }}>
      ...
      <section className="py-20 bg-gradient-to-tr from-primary to-accent">
        <div className="container mx-auto px-4 text-center">
          ...
          <Button size="lg" variant="secondary" asChild className="text-primary hover:bg-background/90 hover:text-primary shadow-lg hover:scale-105 transition-transform animate-in fade-in zoom-in-95 duration-700 delay-400">
             <Link href={currentUser?.isLoggedIn ? "/dashboard" : "/auth/register"}>
